    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/storage/img/{{$product->image}}" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">{{ $product->name }} - {{$product->variant}}</h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">{{ $product->price }} BDT</h3>
                <div class="d-flex mb-1">
                    <p class="text-dark font-weight-medium mb-0 mr-3">Shop:</p>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    ...
                    <a class="nav-item nav-link" data-toggle="tab" href="#tab-pane-2">Specification</a>
