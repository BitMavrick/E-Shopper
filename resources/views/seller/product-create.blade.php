                ...
                <- Go to List </a>
                    ...
                    <form class="forms-sample" action="{{ route('products.store') }}" method="post"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control editor1" required name="description" id="description"
                                    rows="6">Proper description of the product</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control editor2" required name="specification" id="specification"
                                    rows="7">Enter specification of the product</textarea>
                            </div>
                        </div>
