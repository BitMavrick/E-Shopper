        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control editor3" required name="description" id="description" rows="6" placeholder="Proper description of the product">{{ $product->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control editor4" required name="specification" id="specification" rows="7" placeholder="Enter specification of the product">{{ $product->specification }}</textarea>
                    </div>
                </div>
